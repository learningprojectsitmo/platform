...
Тема : `Добро пожаловать  в Управление проектами по разработке мобильных и сетевых приложений!`
```
    ...
    <tr>
        <td align="center" style="min-width: 590px;">
            <table border="0" cellpadding="0" cellspacing="0" width="590" style="min-width: 590px; background-color: white; padding: 0px 8px 0px 8px; border-collapse:separate;">
                <tr><td valign="middle">
                    <span style="font-size: 10px;">Ваша учетная запись</span><br>
        ...
        <td align="center" style="min-width: 590px;">
            <table border="0" cellpadding="0" cellspacing="0" width="590" style="min-width: 590px; background-color: white; padding: 0px 8px 0px 8px; border-collapse:separate;">
                <tr><td valign="top" style="font-size: 13px;">
                    <div>
                        Уважаемый <t t-out="object.name or ''">Marc Demo</t>,<br><br>
                        Ваша учетная запись успешно создана!<br>
                        Ваш логин <strong><t t-out="object.email or ''">mark.brown23@example.com</t></strong><br>
                        Для получения доступа к своей учетной записи можно воспользоваться следующей ссылкой:
...
EN
Тема : `Welcome to Mobile and network application development project management!`
``` 
